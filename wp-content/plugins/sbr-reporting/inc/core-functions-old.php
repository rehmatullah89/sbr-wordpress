...
function total_item_night_guard_shipped_sbr_report_core($order_start_date, $order_end_date, $order_type = '')
{
    ...
    if ($order_data_results) {
        ...
        //   echo 'Data: <pre>' .print_r($night_guards_product_list,true). '</pre>';
        //  echo 'Data: <pre>' .print_r($order_products,true). '</pre>';
        //   echo 'Data: <pre>' .print_r($order_type,true). '</pre>';
        //   die;
        if ($order_products) {
...
function calcalateGrowthRatio($val1, $val2, $sign = '')
{
    ...
    if ($val1 == $val2) {
        ...
        $percentChange = (($val1 - $val2) / $val1) * 100;
