...
function sbr_reports()
{
    ...
    // $c_end_date = date("Y-m-d", strtotime("-7 month"));;
    // $c_start_date = date("Y-m-d", strtotime("-8 month"));
   ...
   // $response = calculateUpDownCompare($totalOrderitemQuantityResponse, $totalOrderitemQuantityCompare, '_order_shipping', '$',$dateArr);
    ...
    $dateArr = array('start_date' => $start_date, 'end_date' => $end_date, 'cstart_date' => $c_start_date, 'cend_date' => $c_end_date);
     ...
     <table style="max-width:780px;width:100%;margin:0px auto; border-spacing:0px;">
        ...
        <td style="border:1px solid #eee;padding: 5px; font-size:14px;font-family:arial;">' . $totalOrderNumberResponseCompare["responsecurrent"] . '</td>
        <td style="border:1px solid #eee;padding: 5px; font-size:14px;font-family:arial;">' . $totalOrderNumberResponseCompare["responsecompare"] . '</td>
