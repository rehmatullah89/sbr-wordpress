...
<script id="tmpl-bp-avatar-webcam" type="text/html">
	...
	<# } else { #>
		<div id="avatar-to-crop-parent-added">
			<div id="avatar-to-crop"></div>
			<button type="button" class="button avatar-webcam-capture"><?php echo esc_html_x( 'Take Picture', 'button', 'buddypress' ); ?></button>			
		</div>
		<div class="avatar-crop-management">
			...
			<div id="avatar-crop-actions">
				<button type="button" class="button avatar-webcam-save"><?php echo esc_html_x( 'Save Picture', 'button', 'buddypress' ); ?></button>
			</div>
		</div>
	<# } #>
</script>
