...
<script>
	jQuery('body').addClass("affiliateLOginResiterPage")
</script>

<legend class="hidden"><?php _e( 'Register a new affiliate account', 'affiliate-wp' ); ?></legend>
<div class="pageHeading_sec borderBottomLine  paddingBottom15 registerPageHeading">
                <span><span class="text-blue">Register</span> Join our lucrative rewards program.</span> 
            </div>
