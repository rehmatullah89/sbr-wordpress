        ...
        <div class="home-sale-content">
            <div class="content-details">
                ...
                <div class="text-detail">
                    ...
                    <p class="main-text">Today only + <strong style="color:#d4545a" class="extraBold italic"> <em>New</em> </strong> <br> <strong> <em> bundle deals</em></strong></p>

                    <div class="buttons">
                        <p><a href="/sale" class="shop-deals">SHOP DEAL PAGE</a></p>
                        <p><a href="/product/night-guards/  " class="ultrasonic" >
                             <!-- <span>NEW!</span> -->
                             25% OFF NIGHT GUARDS</a></p>
                        <p><a href="/product/teeth-whitening-trays/" class="enamel">
                             <!-- <span>NEW!</span> -->
                             25% OFF WHITENING SYSTEMS</a></p>
                       
                        <p><a href="/product/proshield/" class="dental-stain"><span>NEW!</span> ATHLETIC MOUTH GUARD</a></p>
