        ...
        <div class="row-t text-center align-item-center justify-content-center pos-rel">
            <div class="v-col-sm-6">
                <div class="sectionGraphic">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/sales/2023/labor-day/labor-day-banner-top-left-one-hd.png);" alt="" class="img-fluid hidden-mobile">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/labour-day-september-sale/independence-day-home-banner-mobile.png);" alt="" class="img-fluid hidden-desktop">
                </div>
            </div>
                ...
                <div class="v-col-sm-5  pos-rel largerZ">
                    <div class="sectionTopBanner">
                        ...
                        <div class="people-img">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/labour-day-september-sale/peoples.png);" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
                <div class="sideouter-image">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/sales/2023/labor-day/labor-day-banner-top-right-one.png);" alt="" class="img-fluid">
                </div>
