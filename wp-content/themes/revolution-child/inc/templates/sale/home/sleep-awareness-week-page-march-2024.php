<style>
    ...
    #sale-banner-section .sleep-awareness-week-container {
        background-image: url("<?php echo get_stylesheet_directory_uri(); ?>/assets/images/sales/2024/sleep-awareness-march/sleep-awareness-home-banner.png");
        position: relative;
        min-height: 612px;
        /* min-height: 61vh; */
    }
   ...
   #sale-banner-section .mobile-image {
    ...
    #sale-banner-section .section-action-buttons a {
        max-width: 302px;
        letter-spacing: 0;
        font-weight: 500;
        font-size: 19px;
    ...
    #sale-banner-section span.stars.starOne {
        left: 321px;
        top: 20px;
    }
    ...
    #sale-banner-section .section-action-buttons .reorder-night-guards {
        background: #331f98;
        border-color: #331f98;
    }
...
<section id="sale-banner-section">
    <div class="sleep-awareness-week-container">
        ...
        <div class="star diff pos1"><img class=""
                src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/sales/2024/sleep-awareness-march/star.png"
                alt="" /></div>

        <div class="star diff pos4"><img class=""
                src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/sales/2024/sleep-awareness-march/star.png"
                alt="" /></div>

        <div class="star diff pos5"><img class=""
                src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/sales/2024/sleep-awareness-march/star.png"
                alt="" /></div>
        <div class="star diff pos6"><img class=""
                src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/sales/2024/sleep-awareness-march/star.png"
                alt="" /></div>
        <div class="star diff">*</div>

        <div class="star diff pos7"><img class=""
                src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/sales/2024/sleep-awareness-march/star.png"
                alt="" /></div>

        <div class="star diff pos8"><img class=""
                src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/sales/2024/sleep-awareness-march/star.png"
                alt="" /></div>

        <div class="star diff pos9"><img class=""
                src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/sales/2024/sleep-awareness-march/star.png"
                alt="" /></div>

        <div class="clouds"></div>
        <span class="stars starOne"> <img class=""
                src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/sales/2024/sleep-awareness-march/star.png"
                alt="" /></span>
        ...
        <span class="stars starFive"> <img class=""
                src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/sales/2024/sleep-awareness-march/star.png"
                alt="" /></span>
            ...
            <div class="row-wrap">
                ...
                <div class="save-discount-section">
                    ...
                    <div class="section-action-buttons">
                        <a class="btn btn-primary-teal" href="/product/night-guards">SHOP NIGHT GUARD KITS</a>
                        <a class="btn btn-primary-teal reorder-night-guards" href="/my-account/orders">REORDER NIGHT
                            GUARDS</a>
                    </div>
...
<script>
    ...
    $(function () {
        setInterval(function () {
            $('.starOne').fadeIn(300).delay(2000).fadeOut(150).delay(1254);
