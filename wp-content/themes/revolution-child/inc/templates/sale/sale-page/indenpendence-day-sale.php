...
#solid-color-with-text-section{margin-top: 65px;}
    ...
    border-bottom: 1px solid #fff;
      ...
      /* background-image:url(/wp-content/themes/revolution-child/assets/images/Independance-day-sale/independence-day-sale-repeater.png);   */
      background:#e7f3fa;
    }
    ...
    .indepndence-dayText:before,.indepndence-dayText:after{

        content: '';

        background: url(/wp-content/themes/revolution-child/assets/images/Independance-day-sale/stars-img.png);
        ...
        height: 9px;background-repeat: repeat;
...
<section id="solid-color-with-text-section">
    ...
    <!-- <div class="backgroundImageLargeDesktop">

        <img src="<?php //echo get_stylesheet_directory_uri(); ?>/assets/images/Independance-day-sale/independence-day-home-banner.png);" alt="" class="img-fluid">        
        ...
        <div class="row-t text-center align-item-center justify-content-center pos-rel">
            ...
            <div class="v-col-sm-5 order2 pos-rel largerZ">
                ...
                <div class="sectionTopBanner">
                    <div class="graphic_logo" style="display:none;">
                    ...
                    <!-- <p class="font-mont"> Light up the nights sky with your smile this 4th of July & save up to 40%</p> -->
