...
.sale-fall-section-heading .yellow-img img{
  max-width: 80%;
}
...
<div class="sale-fall-section-top">
    ...
    <div class="leaf_bg_two">
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/sales/2024/fall-sale/sale-right-img.png" alt="leaf3">
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-7">
                <div class="sale-fall-section-heading">
                  ...
                  <p class="desktop-hidden">Harvest up to 40% off <br> on oral care must-haves. <br>
    ...
    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/sales/2024/fall-sale/salr-left-bottom-img.png" alt="bottom-left_img">
