		...
		<div class='deal-top-bar' style='<?php echo $deal_alert_text_wrap_style; ?>' onclick='<?php echo $deal_alert_on_click; ?>'>
			<div class="container">
				...
				<div class="flex-div ">
					...
					<div class="flex-div-innerleft max-heightForMobile">
						...
						<span class='deal-left-text '>
							...
							<span class="site-widetext">
								...
								<span><b>New Year Sale </b>
									<!-- <span class="hidden-mobile">Ends:</span> -->
								</span>
							</span>
					...
					<a class="btn btn-primary-orange" style="background-color:#1A75A9;border-color:#1A75A9;" href="/sale">SHOP DEALS</a>
			...
			<div class="collapse navbar-collapse justify-content-between" id="navbarToggle">
				...
				<ul class="nav navbar-nav navbar-left">
					...
					<li class="nav-item sports-guards-nav">
						<a href="/product/proshield/" rel="nofollow" title="Sports Guards">Sports Guards</a>
					</li>
