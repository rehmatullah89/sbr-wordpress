...
<div class="saleParentWrapper">
	<?php
	$start_time_ticker = '2022-10-06 02:00:00';
	$end_time_ticker = '2022-10-10 02:00:00';
	...
	?>
		...
		<style type='text/css'>
			...
			@media(min-width:768px) {
				...
				.page-id-192 #wrapper div[role="main"], .postid-192 #wrapper div[role="main"] {
 				 padding-top: 67px;
				}
			}
			...
			@media(max-width:767px) {
				...
				.bogoDealFace,.textReamining{
					display:none !important;
				}
				.onlyDesktop{ display: none !important;}
				.deal-left-text,span.parentSpan{
					font-size: 14px;
					font-size: 3.6vw;
				}
				.deal-top-bar a.btn {
				...
				<div class="flex-div">
					...
					<div class="flex-div-innerleft max-heightForMobile">
						...
						<span class="site-widetext">
							<span class="onlyDesktop"><span class="textOr">or</span> Site-Wide Savings</span></span>							
						
						<?php //echo $deal_alert_text_primary; ?></span>
