...
<div class="saleParentWrapper">
	<?php
	$start_time_ticker = '2023-5-08 02:00:00';
	$end_time_ticker = '2023-06-19 02:00:00';
				...
				<div class="flex-div ">
					...
					<div class="flex-div-innerleft max-heightForMobile">
						...
						<span class='deal-left-text '>
							...
							<span class="site-widetext">
								<span>Father’s Day  Sale <span class="hidden-mobile">Ends:</span></span>
							</span>
					...
					<div class="flex-div-innerright flex-div curlyBrackets">
						...
						?>
							...
							<span class="dotsSeprator hidden-mobile">:</span>
					...
					<a class="btn btn-primary-orange" style="background-color:#303e48;border-color:#303e48" href="/sale">SEE DEALS</a>
