...
<div class="saleParentWrapper">
	<?php
	$start_time_ticker = '2022-11-08 02:00:00';
	$end_time_ticker = '2022-12-01 02:00:00';
	...
	?>
		...
		<style type='text/css'>
			...
			@media(max-width:767px) {
				...
				.deal-top-bar p, .deal-top-bar span {
						font-size: 14px;
					}
					span.singImage{
						margin-top: 0px;
				...
				<div class="flex-div ">
					...
					<div class="flex-div-innerleft max-heightForMobile">
						...
						<span class='deal-left-text '>
							...
							<span class="site-widetext">
								<span>CYBER MONDAY <span class="hidden-mobile">SALE</span></span>
							</span>
						...
						<a class="btn btn-primary-orange hidden-mobile" href="/sale">SHOP DEALS</a>

					</div>

					<div class="saleDealButton hidden-desktop">
							<a class="btn btn-primary-orange" href="/sale">VIEW DEALS</a>
					</div>
					...
					<div class="flex-div-innerright flex-div curlyBrackets">
						...
						?>
							...
							<span class="parentSpan firstParent" style="display:none;">
