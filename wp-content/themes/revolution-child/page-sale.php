...
#solid-color-with-text-section {background-color: #565759;margin-top: 5rem;}   
...
.product-selection-title-right{width:260px;    margin-right: 0; font-weight:normal;font-style: normal;z-index: 12;} 
        ...
        <div class="container">
            <div class="row-t sep-top-md sep-bottom-md text-center">
                <div class="col-sm-12">
                    ...
                    <div class="exclusive-offer text-white font-mont">Your new years resolution starts right now</div>
                </div>
            </div>
        </div>            
    </section>
        ...
        <div class="container max1250">
            ...
            <div class="col-sm-6 no-gutters">
                ...
                <div class="col-sm-6 no-gutters" >
					...
					<a rel="nofollow" href="/product/sensitive-teeth-gel" class="btn btn-primary-purple">DESENSITIZING GEL REFILLS</a>
                </div>
                </div>
				</div>                
                ...
                <div class="col-lg-12">
                         ...
                         <div class="product-selection-box">
							<div class="row-t">
								...
								<div class="product-selection-title-right">
                                    <span class="availableItem">133 STILL AVAILABLE</span> <span class="saveOnItem">SAVE 50%</span>
								</div>
							</div>
							<div class="row-t">
									...
									<div class="product-selection-description-text">
                                        ...
                                        <div class="row-mbt-product justify-content-between maxwidth80" style="margin-top:60px;">
                                            ...
                                            <div class="sale-price">
                                                ...
                                                <div class="price-new "><span class="doller-sign">$</span>115</div>                                                
                                            </div>

                                        </div>

                                        <div class="add-to-cart">
										<button class="btn btn-primary-blue btn-lg product_type_simple add_to_cart_button ajax_add_to_cart" href="?add-to-cart=735288" data-quantity="1" data-product_id="735288" data-action="woocommerce_add_order_item">ADD TO CART</button>
                                    </div>
                        ...
                        <div class="product-selection-box">
							<div class="row-t">
								...
								<div class="product-selection-title-right">
                                    <span class="availableItem">253 STILL AVAILABLE</span> <span class="saveOnItem">SAVE 34%</span>
								</div>
							</div>
							<div class="row-t">
                                <div class="col-sm-6 col-md-7">
								...
								<div class="col-sm-6 col-md-5 product-selection-description-text-wrap">
									<div class="product-selection-description-text">
                                        ...
                                        <div class="row-mbt-product justify-content-between maxwidth80" style="margin-top:60px;">
                                            ...
                                            <div class="sale-price">
                                                <div class="price-heading blue-text">SALE PRICE</div>
                                                <div class="price-new "><span class="doller-sign">$</span>65</div>                                                
                                            </div>

                                        </div>
                                        <div class="add-to-cart">
										<button class="btn btn-primary-blue btn-lg product_type_simple add_to_cart_button ajax_add_to_cart" href="?add-to-cart=<?php echo CARIPRO_CORDLESS_WATER_FLOSSER_4_TIPS_ID;?>" data-quantity="1" data-product_id="<?php echo CARIPRO_CORDLESS_WATER_FLOSSER_4_TIPS_ID;?>" data-action="woocommerce_add_order_item">ADD TO CART</button>
                                    </div>
                        ...
                        <div class="product-selection-box" id="stock-save-bundles">
							<div class="row-t">
								...
								<div class="product-selection-title-right">
                                    <span class="availableItem">155 STILL AVAILABLE</span> <span class="saveOnItem">SAVE 38%</span>
								</div>
							</div>
							<div class="row-t">
                                <div class="col-sm-6 col-md-7">
								...
								<div class="col-sm-6 col-md-5 product-selection-description-text-wrap">
									<div class="product-selection-description-text">
                                        ...
                                        <div class="row-mbt-product justify-content-between maxwidth80" style="margin-top:60px;">
                                            ...
                                            <div class="sale-price">
                                                <div class="price-heading blue-text">SALE PRICE</div>
                                                <div class="price-new "><span class="doller-sign">$</span>49</div>                                                
                                            </div>

                                        </div>

                                        <div class="add-to-cart">
										<button class="btn btn-primary-blue btn-lg button-blue-drk product_type_simple add_to_cart_button ajax_add_to_cart" href="?add-to-cart=735289" data-quantity="1" data-product_id="735289" data-action="woocommerce_add_order_item">ADD TO CART - adult bundle</button>
										<button class="btn btn-primary-blue btn-lg button-pink product_type_simple add_to_cart_button ajax_add_to_cart" href="?add-to-cart=735290" data-quantity="1" data-product_id="735290" data-action="woocommerce_add_order_item">ADD TO CART - kids bundle</button>                                   
                                    </div>
									</div>
                        ...
                        <div class="product-selection-box">
							<div class="row-t">
								...
								<div class="product-selection-title-right">
                                    <span class="availableItem">167 STILL AVAILABLE</span> <span class="saveOnItem">SAVE 49%</span>
								</div>
							</div>
							<div class="row-t">
                                <div class="col-sm-6 col-md-7">
                                    <div class="product-image">
                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/black-friday-sale/product-deluxe-electric-toothbrush.jpg" alt="">                                             
                                    </div>
                                </div>
                                <div class="col-md-1"></div>
								<div class="col-sm-6 col-md-5 product-selection-description-text-wrap">
									<div class="product-selection-description-text">
                                        ...
                                        <div class="row-mbt-product justify-content-between maxwidth80" style="margin-top:60px;">
                                            ...
                                            <div class="original-price">
                                                <div class="price-heading gray-text">ORIGINAL PRICE</div>
                                                <div class="price-was gray-text line-thorough"><span class="doller-sign">$</span>129</div>                                                
                                            </div>
                                        ...
                                        <div class="add-to-cart">
										<button class="btn btn-primary-blue btn-lg product_type_simple add_to_cart_button ajax_add_to_cart" href="?add-to-cart=<?php echo DELUXE_PACKAGE_CARIPRO_TOOTHBRUSH_4_HEADS_ID;?>" data-quantity="1" data-product_id="<?php echo DELUXE_PACKAGE_CARIPRO_TOOTHBRUSH_4_HEADS_ID;?>" data-action="woocommerce_add_order_item">ADD TO CART</button>
                                    </div>
