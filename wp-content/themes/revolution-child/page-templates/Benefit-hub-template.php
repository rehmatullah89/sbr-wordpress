<?php
/*Template Name:  Benefit Hub Template */

global $GEHA_PAGE_ID;
//$GEHA_PAGE_ID =  get_the_ID();
$GEHA_PAGE_ID = BENEFIT_TEMPLATE_PAGE_ID;
if (function_exists('w3tc_flush_url')) {
    w3tc_flush_url(get_permalink(get_the_ID()));
}
session_start();
$benefithubFlag = false;
if (isset($_GET['utm_campaign']) && $_GET['utm_campaign'] == 'userExists') {
    setcookie('benefithub', 'yes', time() + (3600 * 24 * 360), '/');
    $_SESSION['benefithub'] = 'yes';
    set_transient('benefithub', 'yes', 365 * DAY_IN_SECONDS);
    if (is_user_logged_in()) {
        update_user_meta(get_current_user_id(), 'benefithub', 'yes');
    }
    $benefithubFlag = true;
    if (function_exists('w3tc_flush_url')) {
        w3tc_flush_url(get_permalink(get_the_ID()));
...
if (isset($_SESSION['benefithub']) && $_SESSION['benefithub'] == 'yes') {
    $benefithubFlag = true;
}
if (isset($_COOKIE['benefithubOneTime']) && $_COOKIE['benefithubOneTime'] == 'yes') {
    $benefithubFlag = true;
    setcookie('benefithubOneTime', '', time() - 100000, '/');
}
if (get_transient('benefithub') == 'yes') {
    // $benefithubFlag = true;
}

if (is_user_logged_in()) {
    if (get_user_meta(get_current_user_id(), 'benefithub', true) == 'yes') {
        $benefithubFlag = true;
    }
}
...
#product-list.productLandingPageContainer .medium-8.landing-product .woocommerce-Price-amount.amount, #product-list .medium-4.landing-product.child-5 .woocommerce-Price-amount.amount
    , #product-list.productLandingPageContainer .medium-8.landing-product .woocommerce-Price-amount.amount bdi, #product-list .medium-4.landing-product.child-5 .woocommerce-Price-amount.amount bdi
    {
        font-size: 28px;
        font-weight: 400;
    }
...
@media (min-width: 991px) {
        ...
        #product-list.grid-changed .medium-8 .product-selection-image-wrap, #product-list.grid-changed .medium-4 .product-selection-image-wrap {
    min-height: 300px;
    max-width: 375px;
    max-height: 300px;
    overflow: hidden;
    ...
    @media (max-width: 767px) {
        ...
        #gehaPage .seeDiscountBtn button, #product-list .medium-12.thb-dark-column.small-12.landing-product .product-selection-description-parent-inner .discount-button-product .btn-primary-blue {
            font-size: 16px;
            display: block;
            width: 100%;
            max-width: 95%;
        ...
        .child-4 .product-selection-box img, .child-0 .product-selection-box img, .child-5 .product-selection-box img, .child-6 .product-selection-box img {
    ...
    @media(max-width:480px) {
        ...
        #gehaPage .geha-banner-text-section h2 {
            padding: 20px 0px 0px;         font-size: 20px !important;
        }
...
<div class="gehaTemplate active-recomendation-tab" id="gehaPage">
    ...
    if ($benefithubFlag) {
        $page_id = BENEFIT_REC_PAGE_ID; // Replace 123 with the ID of the page you want to retrieve
    ...
    ?>
                ...
                <div class="pageHeader">
                    ...
                    <div class="pageheaderTop">
                        ...
                        <div class="row no-flex">
                            <div class="flex align-items-center mobile-responsie">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/benefit-hub/BenefitHub.png" alt="Benefit Hub" data-src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/benefit-hub/BenefitHub.png" decoding="async" class="lazyload">
                                <h1 class="font-mont weight-500 m0 text-white">DISCOUNTS</h1>
                            </div>
                            <p class="open-sans text-white">
                                Welcome BenefitHub member! Save up to 50% on your Oral Care needs!<br>
                                Shop below to recieve your exclusive discounts
                            </p>

                            <div class="whitening-teeth-girl-with-smile hidden-mobile">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/benefit-hub/homepage-circle-graphic.png" alt="homepage hero" data-src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/benefit-hub/homepage-circle-graphic.png" decoding="async" class="lazyload">
                            </div>
            ...
            <div id="product-list" class="row teethWhieteingSystemWrapper productLandingPageContainer">
                        ...
                        <div class="rowMbt">
                            <div class="col-sm-4 geha-banner-text-section-parent">
                                <div class="geha-banner-text-section  mt-100">
                                    ...
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/benefit-hub/BenefitHub.png" alt="One Dental" class="" />
                                    <div class="smtext">
                                        <h2 class="font-mont text-blue-500 fw-normal">Exclusive discounts for<br>
                                            BenefitHub members & their<br>families!</h2>
                                        ...
                                        <div class="gehaLoginCustomer">
                                            <h3 class="font-mont">ALREADY REGISTERED? <a href="/my-account/" class="onpreColor onpostColor">Login</a> </h3>
                                        </div>
                            ...
                            <div class="whitening-teeth-girl-with-smile col-sm-8 graphicImagePeople">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/benefit-hub/homepage-circle-graphic.png" alt="" data-src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/benefit-hub/homepage-circle-graphic.png" decoding="async" class="lazyload">
                            </div>
                ...
                <section class="ourSuportedCustomers product-logo-wrapper bg-sky-500 smilePageIconSection smilePageIconSection-parent-div ">
                                        ...
                                        <div class="widget widget_text">
                                            <div class="textwidget">
                                                <p>Smile Brilliant is America's #1 brand of customized oral care products and a
                                                    proud partner of Benefithub Insurance. All Benefithub clients, their children, domestic
                                    ...
                                    <div class="vc_wp_text wpb_content_element order-the-system-cnt">
                                        <div class="widget widget_text">
                                            <div class="textwidget">
                                                ...
                                                <div class="seeDiscountBtn text-center">
                                                    <button class="btn btn-primary-blue btn-lg scroll-link" href="#gehaform">SEE YOUR BENEFITHUB DISCOUNTS</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="container-form">
                            <form id="geha_discount_registration_form" method="post">
                                <div class="row form-steps fullWidth">
                                    <div class="col-sm-12 tp-head-form">
                                        <div class="logo">
                                            <h1 class="gehaLogoLarge">
                                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/benefit-hub/BenefitHub.png" alt="Benefit Hub" class="cnfimg" />
                                            </h1>
                                        </div>
                                    ...
                                    <input type="hidden" name="source" value="benefithub">
                                    ...
                                    <div class="col-md-12 text-center form-notes">
                                        <p class="text-white">By registering you will be able to bypass this page on future visits and view Benefits hub discounts so long as we recognize your devise or you’re logged in to your Smile Brilliant account.<strong>DISCLAIMER: </strong><i> These benefits are neither offered nor guaranteed under contract with the FEHB or FEDVIP Programs, but are made available to all Enrollees who become members of Benefithub and their eligible family members.</i></p>
                                    </div>
                                    ...
                                    <div class="gehaLoginCustomer w-100 text-center">
                                        <div class="registeded-btn-stp">
                                            ...
                                            <div class="stip-sttpp">or <a href="javascript:;" id="skipPartner">skip</a></div>
                                        </div>
                                    </div>
                                </div>
            ...
            <?php if ($benefithubFlag) {               
                    echo '<style>.footer {padding: 0px 0;}</style>
                    <div class="disclaimer-bar-purple bgColor">
                    <div class="container">
                     <p class="postLoggedin text-white">“<strong>DISCLAIMER:</strong><i>In order to recieve BenefitHub exclusive pricing you must add to cart from this page.</i></p>
                    </div>
                    </div>';
            }
            ?>
        ...
        <div class="modal-content">
            ...
            <div class="popupBodyContent text-center">
                <h1 class="gehaTextmember">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/benefit-hub/BenefitHub.png" alt="BenefitHub" class="" />
                </h1>
                ...
                <p class="descriptionBody">Welcome Benefithub member! You now have access to give your exclusive Benefithub discounts. An email has also been sent to you with your account login details. To view your discounts in the future, simply login. Our live chat and customer support team is also here to help!<br><br>
                ...
                <div class=" sep-top-sm text-center seeDiscountBtn text-center">
                    <a href="<?php echo site_url('benefithub?user=yes'); ?>" class="btn">SEE DISCOUNT PAGE</a>
                </div>
            </div>
        </div>
    </div>
