<?php
/*Template Name: Dental Probiotics upsell*/
get_header();
?>
<style>
    .section-head {
...
<section>
    <div class="section-head">
        <div>
            ...
            <p class="font-mont">This is your ONLY chance to <span style="color: #005a5d;font-size: 125%;font-weight: bold;">SAVE <?php echo do_shortcode('[wfocu_product_save_percentage key="1"]'); ?></span> on Dental Probiotics</p>
        </div>
    </div>
                ...
                <div class="col-7 m-order-2">
                    <div class="content-left-section">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <h2 class="font-mont">
                                Enjoy your  <br><span style="color:#0eb4ba;">EXCLUSIVE
                                    <?php echo do_shortcode('[wfocu_product_save_percentage key="1"]'); ?> DISCOUNT</span> on
                               
                                <span style="color:#945aa5;">Dental Probiotics</span>
                            </h2>
                            <ul class="listing">
                                <!-- <li>Prevent Cavities</li>
                                <li>Reduce Bad Breath</li>
                                <li>Support Healthy Gum</li>
                                <li>Increase Good Bacteria</li>
                                <li>Strengthens Immunity</li> -->
                                <li>Combats Bad Breath</li>
                                <li>Fights Plaque Build-up & Decay</li>
                                <li>Builds Natural Immune Defenses</li>
                                <li>Balances Oral Acidity (pH)</li>

                            </ul>
                        </div>

                        <div class="wraning-box">
                            <p class="">Only 8 Dental Probiotics left!</p>
                    ...
                    <div class="product-image mrge-with-right-side">
                        ...
                        <div class="content show radio-30-days-content" id="">
                            <div class="image-wrapper">
                                ...
                                <img src="https://www.smilebrilliant.com/wp-content/uploads/2024/10/Probiotic-1-bottle.png">
                            </div>
                        </div>
                        <div class="content radio-60-days-content" id="">
                            <div class="image-wrapper">
                            <img src="https://www.smilebrilliant.com/wp-content/uploads/2024/10/Probiotic-2-bottle.png">
                            </div>
                        </div>
                        <div class="content radio-90-days-content" id="">
                            <div class="image-wrapper">
                            <img src="https://www.smilebrilliant.com/wp-content/uploads/2024/10/Probiotic-3-bottle.png">
                            </div>
                        </div>
                    ...
                    <div class="thumbs-products">
                        <div class="d-flex align-items justify-content-center">
                            <span class="item-thumbs">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/improves-sinhus-health-upsell.png">
                                <span class="info"> IMPROVES SINUS HEALTH </span>
                            </span>
                            <span class="item-thumbs" style="background: #0eb4ba;">
                                ...
                                <span class="info">FIGHTS INFECTION & DECAY</span>
                            </span>
                            <span class="item-thumbs brilliant-teeth">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/superior-oral-care-upsell.png"> <span class="info">FIGHTS BAD BREATH</span>
                            </span>
