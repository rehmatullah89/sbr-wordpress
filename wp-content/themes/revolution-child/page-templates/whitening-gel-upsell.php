<?php
/*Template Name:Whitening Gel Upsell*/
get_header();
?>
...
<section>
    <div class="section-head">
        <div>
            ...
            <p class="font-mont">This is your ONLY chance to <span style="color: #ba3c27;font-size: 125%;font-weight: bold;">Get a Huge Discount <?php echo do_shortcode('[wfocu_product_save_percentage]'); ?></span> on Desensitizing Gel</p>
        </div>
    </div>
                ...
                <div class="col-7 m-order-2">
                    <div class="content-left-section">
                        <div class="show-only-desktop">
                            ...
                            <h2 class="font-mont">
                                Enjoy your<span style="color:#ba3c27;"><br>EXCLUSIVE
                                    DISCOUNT</span>
                                <br>
                                <span style="color:#009EAA;">Extra Teeth Whitening Gels</span>
                            </h2>
                            <ul class="listing">
                                <li>Remove Deep Stains</li>
                ...
                <div class="col-5 m-order-1">
                    ...
                    <div class="product-image mrge-with-right-side">
                        <div class="image-wrapper desktop-img">
                            <img src="https://www.smilebrilliant.com/wp-content/themes/revolution-child/assets/images/upsell/whitening-large.png" alt="">
                        </div>
                    ...
                    <div class="thumbs-products">
                        <div class="d-flex align-items justify-content-center">
                            <span class="item-thumbs thumb-one">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/whitening-thumb-1.png" alt="">

                            </span>
                            <span class="item-thumbs">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/whitening-thumb-2.png" alt="">

                            </span>
                            <span class="item-thumbs brilliant-teeth">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/whitening-thumb-3.jpg" alt="">
