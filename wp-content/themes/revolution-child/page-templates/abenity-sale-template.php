<?php
/*Template Name:  Abenity Sale Lander Template */

global $GEHA_PAGE_ID;
//$GEHA_PAGE_ID =  get_the_ID();
$GEHA_PAGE_ID = ABNENITY_TEMPLATE_PAGE_ID;
...
if (isset($_GET['utm_campaign']) && $_GET['utm_campaign'] == 'userExists') {
    setcookie('abenity', 'yes', time() + (3600 * 24 * 360), '/');
    $_SESSION['abenity'] = 'yes';
    set_transient('abenity', 'yes', 365 * DAY_IN_SECONDS);
    if (is_user_logged_in()) {
        update_user_meta(get_current_user_id(), 'abenity', 'yes');
    }
    $abenityFlag = true;
    if (function_exists('w3tc_flush_url')) {
        w3tc_flush_url(get_permalink(get_the_ID()));
...
if (isset($_SESSION['abenity']) && $_SESSION['abenity'] == 'yes') {
    $abenityFlag = true;
}
if (isset($_COOKIE['abenityOneTime']) && $_COOKIE['abenityOneTime'] == 'yes') {
    $abenityFlag = true;
    setcookie('abenityOneTime', '', time() - 100000, '/');
}
if (get_transient('abenity') == 'yes') {
    // $abenityFlag = true;
}

if (is_user_logged_in()) {
    if (get_user_meta(get_current_user_id(), 'abenity', true) == 'yes') {
        $abenityFlag = true;
    }
}
...
<style>
    ...
    .page-template-page-templatesabenity-template-php .has_error {
    ...
    .popupBodyContent.text-center .gehaTextmember .abenity-logo-circle{
        max-width: 252px;
    }
...
<div class="gehaTemplate active-recomendation-tab" id="gehaPage">
    ...
    if ($abenityFlag) {
        $page_id = ABNENITY_REC_PAGE_ID; // Replace 123 with the ID of the page you want to retrieve
                    ...
                    <div class="pageheaderTop">
                        ...
                        <div class="row no-flex">
                            <div class="flex align-items-center mobile-responsie li-tpt">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/abenity-sale-lander/abenity-logo.png"
                                    alt="Abenity"
                                    data-src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/abenity-sale-lander/abenity-logo.png"
                                    decoding="async" class="lazyload max-238">
                                <h1 class="font-mont weight-500 m0 text-blue" style="color:#325077;">DISCOUNTS</h1>
                            </div>
                            <p class="open-sans ">
                                Welcome Abenity member! Save up to 50% on your Oral Care needs!<br> Shop below to recieve your
                                exclusive discounts
                            </p>
                            ...
                            <div class="whitening-teeth-girl-with-smile hidden-mobile">
                                ...
                                <div class="primary-head-image">
                                    <img src="https://www.smilebrilliant.com/wp-content/themes/revolution-child/assets/images/abenity-sale-lander/complete-control.png"
                                        alt=""
                                        data-src="https://www.smilebrilliant.com/wp-content/themes/revolution-child/assets/images/abenity-sale-lander/complete-control.png"
                                        decoding="async" class="lazyload">
                                </div>
        ...
        ?>
                    ...
                    <div class="container">
                        <div class="rowMbt">
                            <div class="col-sm-4 geha-banner-text-section-parent">
                                <div class="geha-banner-text-section  mt-100">
                                    <p class="font-mont text-white prpt">PRODUCT 
                                        PARTNER OF</p>
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/abenity-sale-lander/abenity-logo.png"
                                        alt="One Dental" class="abenity-logo-circle" />
                                    <div class="smtext">
                                        <div class="smtext-inr">
                                            <h2 class="font-mont fw-normal">
                                                <span class="weight-lower-mbt">Exclusive Smile Brilliant discounts for Abenity members & their families!</span>
                                            </h2>
                            ...
                            <div class="whitening-teeth-girl-with-smile col-sm-8 graphicImagePeople">
                                <div class="primary-head-image">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/abenity-sale-lander/complete-control.png"
                                        alt=""
                                        data-src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/abenity-sale-lander/complete-control.png"
                                        decoding="async" class="lazyload">
                                </div>
                            </div>
                ...
                <section class="ourCustomers">
                    <div class="container text-center">
                        ...
                        <h3>Over <span style="color:#3c9d36">1 million happy customers</span> have relied on Smile Brilliant
                            to<br>
                                        ...
                                        <div class="widget widget_text">
                                            <div class="textwidget">
                                                <p>Smile Brilliant is America's #1 brand of customized oral care products
                                                    and a
                                                    proud partner of Abenity Insurance. All Abenity clients, their
                                                    children, domestic
                                            ...
                                            <div class="textwidget">
                                                ...
                                                <div class="seeDiscountBtn text-center">
                                                    <button class="btn btn-primary-blue btn-lg scroll-link"
                                                        href="#gehaform">SEE ABENITY DISCOUNTS</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="container-form">
                            <form id="geha_discount_registration_form" method="post">
                                <div class="row form-steps fullWidth">
                                        ...
                                        <div class="flex-item-wrap">
                                            <div class="logo">
                                                <h1 class="gehaLogoLarge">
                                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/abenity-sale-lander/amenty-logo-white.png"
                                                        alt="" class="cnfimg" />
                                    ...
                                    <input type="hidden" name="source" value="abenity">
                                    ...
                                    <div class="col-md-12 text-center form-notes">
                                        <p class="text-white">By registering you will be able to bypass this page on future
                                            visits and view Abenity exclusive discounts so long as we recognize your devise
                             ...
                             <p class="disclaimer-text">
                                 DISCLAIMER: These benefits are neither offered nor guaranteed under contract with the FEHB or FEDVIP Programs, but are made available to all Enrollees who become members of GEHA and their eligible family members.
                             </p>
    ...
    <?php if ($abenityFlag) {
        echo '<style>.footer {padding: 0px 0;}</style>
                    ...
                    <div class="container">
                     <p class="postLoggedin text-white">“<strong>DISCLAIMER:</strong> In order to recieve abenity exclusive pricing you must add to cart from this page.</i></p>
                    </div>
                    </div>';
    }
    ?>
    ...
    <div class="modal">
        <div class="modal-content">
            ...
            <div class="popupBodyContent text-center">
                ...
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/abenity-sale-lander/abenity-logo.png"
                                        alt="Abenity" class="abenity-logo-circle" />
                ...
                <p class="descriptionBody">Welcome Abenity member! You now have access to give your exclusive
                    Abenity discounts. An email has also been sent to you with your account login details. To view
                ...
                <div class=" sep-top-sm text-center seeDiscountBtn text-center">
                    <a href="<?php echo site_url('abenity?user=yes'); ?>" class="btn">SEE DISCOUNT PAGE</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    jQuery(document).on('click', '#skipPartner', function (e) {
        ...
        setCookiePartner('abenityOneTime', 'yes', 200, '/');
        location.reload();
    });
        ...
        jQuery.ajax({
            ...
            success: function (response) {
                ...
                if (response.status == true) {
                    ...
                    setCookiePartner('abenityOneTime', 'yes', 2000, '/');
                    // location.reload();
                    // setTimeout(function() {
    ...
    jQuery(document).on('change', 'input[name="fav_language"]', function() {
        ...
        var abenity_sale_price = $(this).attr('data-abenity_sale_price');
        if (typeof abenity_sale_price !== 'undefined' && abenity_sale_price !== false && abenity_sale_price != '' && abenity_sale_price > 0) {
            jQuery(this).parents('.product-selection-box').find('.add_to_cart_button').attr('data-abenity_sale_price', abenity_sale_price);
        } else {
            jQuery(this).parents('.product-selection-box').find('.add_to_cart_button').removeAttr('data-abenity_sale_price');
        }
        jQuery(this).parents('.product-selection-box').find('.add_to_cart_button').attr('data-product_id', selected_product_id);
        jQuery(this).parents('.product-selection-box').find('.add_to_cart_button').attr('href', '?add-to-cart=' + selected_product_id);
        if (av_price != '') {
