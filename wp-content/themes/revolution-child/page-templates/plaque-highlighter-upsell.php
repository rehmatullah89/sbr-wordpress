<?php
/*Template Name: plaque highlighter upsell*/
get_header();
?>
<style>
    .section-head {
    ...
    .form-group-radio-custom [type="radio"]:checked+label {
        background: #e9cbe2;
    border-color: #9e1e82 !important;
    }
    .form-group-radio-custom [type="radio"]:checked + label:after, .form-group-radio-custom [type="radio"]:not(:checked) + label:after {
        background: #9e1e82;
    }
    ...
    @media only screen and (max-width: 767px) {
        ...
        p.this-one-time-offer {
            padding: 10px 10px 10px 10px;        padding-left: 24px;
        }
        ...
        .show-only-mobile.content-left-section {
    display: none;
}
.show-only-desktop {
    display: block;
...
<section>
    <div class="section-head">
        <div>
            ...
            <p class="font-mont">This is your ONLY chance to <span style="color: #9e1e82;font-size: 125%;font-weight: bold;">SAVE <?php echo do_shortcode('[wfocu_product_save_percentage key="1"]'); ?></span> on Plaque HIGHLIGHTERS</p>
        </div>
    </div>
            ...
            <div class="flex-row">
                <div class="col-7 m-order-2">
                    <div class="content-left-section">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <h2 class="font-mont">
                                Enjoy your  <br><span style="color:#002245;">EXCLUSIVE
                                    <?php echo do_shortcode('[wfocu_product_save_percentage key="1"]'); ?> DISCOUNT</span> on
                               
                                <span style="color:#9e1e82;">Plaque HIGHLIGHTERS</span>
                            </h2>
                            <ul class="listing">
                                <li>Improves Quality of Brushing</li>
                                <li>Makes Plaque & Tartar Easy to See</li>
                                <li>Helps Fight Cavities & bad breath</li>
                                <li>Supports Better Oral Health</li>
                            </ul>
                        </div>

                        <div class="wraning-box">
                            <p class="">Only 8 Plaque HIGHLIGHTERS left!</p>
                        ...
                        <div class="wrapper flex-wrapper">
                            <div class="form-group-radio-custom">
                                ...
                                <label for="30-days" class="option ">
                                    ...
                                    <span class="mmpopular"> day supply</span>
                                </label>
                            </div>
                            <div class="form-group-radio-custom">
                ...
                <div class="col-5 m-order-1">
                    ...
                    <div class="show-only-mobile content-left-section">
                        <div class="d-flex align-items-center justify-content-center">
                            <span class="wraning-icon">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/warning-icon.svg" alt="" />
                            </span>
                            <p class="mb-0 this-one-time-offer font-mont">
                        ...
                        <h2 class="font-mont">
                            Enjoy your <span style="color:#0eb4ba;">EXCLUSIVE
                                <?php echo do_shortcode('[wfocu_product_save_percentage key="1"]'); ?> DISCOUNT</span> on
                            <br>
                            <span style="color:#945aa5;">Plaque HIGHLIGHTERS</span>
                        </h2>
                    </div>
                    ...
                    <div class="product-image mrge-with-right-side">
                        ...
                        <h1 id="fresh-take-text" class="section-header-teal medium">Plaque HIGHLIGHTERS</h1> -->
                        ...
                        <div class="content show radio-30-days-content" id="">
                            <div class="image-wrapper">
                                ...
                                <img src="https://www.smilebrilliant.com/wp-content/uploads/2024/10/highlighters-30-day.png">
                            </div>
                        </div>
                        <div class="content radio-60-days-content" id="">
                            <div class="image-wrapper">
                            <img src="https://www.smilebrilliant.com/wp-content/uploads/2024/10/highlighters-60-day.png">
                            </div>
                        </div>
                        <div class="content radio-90-days-content" id="">
                            <div class="image-wrapper">
                            <img src="https://www.smilebrilliant.com/wp-content/uploads/2024/10/highlighters-90-day.png">
                            </div>
                        </div>



                        <!-- <img width="775" height="656" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/dental-probiotic-upsell.png"> -->

                    </div>
                    <div class="thumbs-products">
                        <div class="d-flex align-items justify-content-center">
                            <span class="item-thumbs">
                                <img src="https://www.smilebrilliant.com/wp-content/themes/revolution-child/assets/images/products/plaque-highlighter-new/circle.png">
                                <span class="info"> SEE YOUR PLAQUE </span>
                            </span>
                            <span class="item-thumbs" style="background: #0eb4ba;">
                                <img src="https://www.smilebrilliant.com/wp-content/uploads/2021/09/blue-section-probiotics-adult-happy-oral-health.png" style="max-width: 80%;">
                                <span class="info">IMPROVES BRUSHING</span>
                            </span>
                            <span class="item-thumbs brilliant-teeth">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/superior-oral-care-upsell.png"> <span class="info">SUPERIOR ORAL CARE</span>
                            </span>
