<?php
/*Template Name: Cardless water flosser upsell*/
get_header();
?>
...
<section>
    <div class="section-head">
        <div>
            ...
            <p class="font-mont">This is your ONLY chance to <span style="color: #0d4666;font-size: 125%;font-weight: bold;">SAVE <?php echo do_shortcode('[wfocu_product_save_percentage]'); ?></span> on the Cordless Water Flosser</p>
        </div>
    </div>
            ...
            <div class="flex-row">
                <div class="col-7 m-order-2">
                    <div class="content-left-section">
                        ...
                        <div class="wraning-box">
                            <p class="">Only 11 CORDLESS WATER FLOSSER left!</p>
                ...
                <div class="col-5 m-order-1">
                    ...
                    <div class="image-wrapper desktop-img">
                        <img src="https://www.smilebrilliant.com/wp-content/themes/revolution-child/assets/images/upsell/water-flosser.png" alt="">
                    </div>
                    <div class="image-wrapper mbl-img">
                        <img src="https://www.smilebrilliant.com/wp-content/themes/revolution-child/assets/images/upsell/cordless-mbl.png" alt="">
                    </div>
                    ...
                    <div class="thumbs-products">
                        <div class="d-flex align-items justify-content-center">
                            ...
                            <span class="item-thumbs brilliant-teeth">
                                ...
                                <span class="info">COMPACT & LIGHTWEIGHT</span>
                            </span>
