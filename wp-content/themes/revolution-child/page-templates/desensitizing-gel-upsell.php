<?php
/*Template Name:Desensitizing Gel Upsell*/
get_header();
?>
...
<section>
    <div class="section-head">
        <div>
            ...
            <p class="font-mont">This is your ONLY chance to <span style="color: #0d4666;font-size: 125%;font-weight: bold;">Get a Huge Discount <?php echo do_shortcode('[wfocu_product_save_percentage]'); ?></span> on Desensitizing Gel</p>
        </div>
    </div>
                ...
                <div class="col-7 m-order-2">
                    <div class="content-left-section">
                        <div class="show-only-desktop">
                            ...
                            <h2 class="font-mont">
                                Enjoy your<span style="color:#0eb4ba;"><br>EXCLUSIVE
                                    DISCOUNT</span>
                                <br>
                                <span style="color:#945aa5;">on Extra Desensitizing Gel</span>
                            </h2>
                            <ul class="listing">
                                <li>Offer Only for First 15 Shoppers</li>
                                <li>Money Back Guarantee</li>
                                <li>Scientifically Engineered</li>
                        ...
                        <div class="wraning-box">
                            <p class="">Only 8 DESENSITIZING GEL SETS left!</p>
                        ...
                        <div class="wrapper flex-wrapper">
                            <div class="form-group-radio-custom">
                                ...
                                <label for="30-days" class="option ">
                                    <div class="dot"></div>
                                    <span class="mmAmount">3</span>
                                    <span class="mmpopular"> Syringes</span>
                                </label>
                            </div>
                            <div class="form-group-radio-custom">
                ...
                <div class="col-5 m-order-1">
                    ...
                    <div class="product-image mrge-with-right-side">
                        <div class="image-wrapper desktop-img">
                            <img src="https://www.smilebrilliant.com/wp-content/themes/revolution-child/assets/images/upsell/desensitizing.png" alt="">
                        </div>
                        <div class="image-wrapper mbl-img">
                            <img src="https://www.smilebrilliant.com/wp-content/themes/revolution-child/assets/images/upsell/desensi-mbl.png" alt="">
                        </div>
                    ...
                    <div class="thumbs-products">
                        <div class="d-flex align-items justify-content-center">
                            <span class="item-thumbs thumb-one">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/deseni-three.png" alt="">

                            </span>
                            <span class="item-thumbs">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/deseni-two.png" alt="">

                            </span>
                            <span class="item-thumbs brilliant-teeth">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/deseni-one.png" alt="">
                                <span class="info">INDIVIDUALLY SEALED</span>
                            </span>
