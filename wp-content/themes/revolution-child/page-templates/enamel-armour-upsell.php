<?php
/*Template Name:Enamel Armour Upsell*/
get_header();
?>
...
<section>
    <div class="section-head">
        <div>
            ...
            <p class="font-mont">This is your ONLY chance to <span style="color: #0d4666;font-size: 125%;font-weight: bold;">Get a Huge Discount <?php echo do_shortcode('[wfocu_product_save_percentage]'); ?></span> on Enamel Armour</p>
        </div>
    </div>
                    ...
                    <div class="content-left-section">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <h2 class="font-mont">
                                ...
                                DISCOUNT</span>
                                <br>
                                <span style="color:#945aa5;">on Enamel Armour</span>
                                </h2>
                            <ul class="listing">
                                <li>Reduces Chronic Tooth Sensitivity</li>
                                <li>Aids in Rebuilding Enamel</li>
                                <li>Helps Fight Cavities</li>
                                <li>Reduces Staining</li>                                                                                                                                                                                                                                                                                                                                                                                                        
                            </ul>
                        </div>

                        <div class="wraning-box">
                            <p class="">Only 8 ENAMEL ARMOURS left!</p>
                        ...
                        <!-- <div class="custom-select">
                            ...
                            <div class="content show radio-30-days-content" id="radio-30-days-content">
                                <!-- <div class="priceExample">30 day supply</div> -->
                        ...
                        <!-- <div class="prices-to-display">
                            <div class="price">
                                <p>Original Price:</p>
                                <div class="was-price">
                                    <del><strong> <?// echo do_shortcode('[wfocu_product_regular_price]'); ?></strong></del>
                                </div>
                            </div>
                            <div class="line-seprator"></div>
                            <div class="price">
                ...
                <div class="col-5 m-order-1">
                    ...
                    <div class="content show radio-30-days-content" id="">
                            <div class="image-wrapper">
                                ...
                                <img src="https://www.smilebrilliant.com/wp-content/uploads/2024/10/enamel-armour-1-tube.png">
                            </div>
                        </div>
                        <div class="content radio-60-days-content" id="">
                            <div class="image-wrapper">
                            <img src="https://www.smilebrilliant.com/wp-content/uploads/2024/10/enamel-armour-2-tube-1.png">
                            </div>
                        </div>
                        <div class="content radio-90-days-content" id="">
                            <div class="image-wrapper">
                            <img src="https://www.smilebrilliant.com/wp-content/uploads/2024/10/enamel-armour-3-tube.png">
                            </div>
                        </div>
                    ...
                    <!-- <div class="image-wrapper desktop-img">
                        <img src="https://www.smilebrilliant.com/wp-content/uploads/2024/10/enamel-armour-2-tube.png" alt="">
                    </div>
                    ...
                    <div class="thumbs-products">
                        <div class="d-flex align-items justify-content-center">
                            <span class="item-thumbs thumb-one">
                                <img src="https://www.smilebrilliant.com/wp-content/uploads/2024/10/oral-cavity-treatment.png" alt="">
                                <span class="info noclrrr">PREVENTS CAVITIES</span>
                            </span>
                            <span class="item-thumbs">
                                <img src="https://www.smilebrilliant.com/wp-content/uploads/2024/10/oral-cavity-treatment-1.png" alt="">
                                <span class="info noclrrrtt">PREVENTS RE-STAINING</span>
                               
                            </span>
                            <span class="item-thumbs brilliant-teeth">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/enamel-three.png" alt="">
                                <span class="info">REDUCES SENSITIVITY</span>
                            </span>
