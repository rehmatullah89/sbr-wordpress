    ...
    if ($page) {
        ...
        <section class="shopLanderPageHader">
            ...
            <div class="pageHeader ">
                <div class="whitening-teeth-girl-with-smile mobileOptionDisplay show-mobile hidden">
                    <!-- <img src="<?php //echo get_stylesheet_directory_uri(); 
                        ?>/assets/images/vip/banner-black-friday-deals-text.png" alt="" data-src="<?php //echo get_stylesheet_directory_uri(); ?>/assets/images/vip/banner-black-friday-deals-text.png" alt="Black Friday Are Live"> -->
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/sales/2022/cyber-monday-sale/cyber-week-text.png"
                        alt="cyber monday Deals Are Live">
                </div>


                <?php
                //get_template_part('inc/templates/sale/home/momorial-day-sale-section-may');
                ?>
                ...
                <!-- style="display:none;" -->
                <div class="pageheaderBotm " style="display:none;">
        ...
        <div id="product-list" class="row teethWhieteingSystemWrapper productLandingPageContainer" style="display:none;">
            <!-- style="display: none;" -->
