<?php
/*Template Name: Dental stain concealer upsell v2*/
get_header();
?>
...
<section>
    <div class="section-head">
        <div>
            ...
            <p class="font-mont">This is your ONLY chance to <span style="color: #0d4666;font-size: 125%;font-weight: bold;"> Save 50% <?php echo do_shortcode('[wfocu_product_save_percentage key="1"]'); ?></span> on a Dental Stain Concealer</p>
        </div>
    </div>
    ...
    <div class="product-wrapper">
                    ...
                    <div class="content-left-section">
                        <div class="show-only-desktop">
                            ...
                            Enjoy your<span style="color:#0eb4ba;"><br>EXCLUSIVE
                                ...
                                <br>
                                <span style="color:#945aa5;">on the Dental Concealer</span>
                            </h2>
                            <ul class="listing">
                        ...
                        <div class="wraning-box">
                            <p class="">Only 8 DENTAL CONCEALERS left!</p>
                ...
                <div class="col-5 m-order-1">
                    ...
                    <div class="product-image mrge-with-right-side">
                        ...
                        <div class="content show radio-60-days-content" id="">
                            ...
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/stain.png" alt="" />
                            ...
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/stain-mbl.png" alt="" />
                    ...
                    <div class="thumbs-products">
                        <div class="d-flex align-items justify-content-center">
                            ...
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/stain1.png" alt="" />

                               
                            </span>
                            <span class="item-thumbs">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/stain2.png" alt="" />
        ...
        <div class="no-thanks-wrap">
            <?php echo do_shortcode('[wfocu_no_link]No thanks, I don’t  want a Dental Concealer.[/wfocu_no_link]'); ?>
