<?php
/*Template Name:  Tele Dentist Sale Lander Template */

global $GEHA_PAGE_ID;
//$GEHA_PAGE_ID =  get_the_ID();
$GEHA_PAGE_ID = TELEDENTIST_TEMPLATE_PAGE_ID;
...
if (isset($_GET['utm_campaign']) && $_GET['utm_campaign'] == 'userExists') {
    setcookie('teledentists', 'yes', time() + (3600 * 24 * 360), '/');
    $_SESSION['teledentists'] = 'yes';
    set_transient('teledentists', 'yes', 365 * DAY_IN_SECONDS);
    if (is_user_logged_in()) {
        update_user_meta(get_current_user_id(), 'teledentists', 'yes');
    }
...
if (isset($_SESSION['teledentists']) && $_SESSION['teledentists'] == 'yes') {
    $teledentistsFlag = true;
}
if (isset($_COOKIE['teledentistsOneTime']) && $_COOKIE['teledentistsOneTime'] == 'yes') {
    $teledentistsFlag = true;
    setcookie('teledentistsOneTime', '', time() - 100000, '/');
}
if (get_transient('teledentists') == 'yes') {
    // $teledentistsFlag = true;
}

if (is_user_logged_in()) {
    if (get_user_meta(get_current_user_id(), 'teledentists', true) == 'yes') {
        $teledentistsFlag = true;
    }
}
...
<style>
    ...
    .page-template-page-templatesteledentists-template-php .has_error {
    ...
    .container-form #geha_discount_registration_form .text-white {
    ...
    .popupBodyContent.text-center .gehaTextmember .teledentists-logo-circle{
        max-width: 252px;
    }
    ...
    .tele-dentist-post-content {
        max-width:700px;
        text-align:center
    }
    .tele-dentist-post-content img {
        max-width:360px;
        padding-bottom:10px;
    }
    p.tele-dentist-post-content{
...
<div class="gehaTemplate active-recomendation-tab" id="gehaPage">
    ...
    if ($teledentistsFlag) {
        $page_id = TELEDENTIST_REC_PAGE_ID; // Replace 123 with the ID of the page you want to retrieve
            ...
            <section class="shopLanderPageHader benefit-hub">
                ...
                <div class="pageHeader">
                    ...
                    <div class="pageheaderTop">
                        ...
                        <p class="font-mont text-white prpt tele-dentist-post-content">PRODUCT PARTNER OF</p>
                            <div class="flex align-items-center mobile-responsie li-tpt tele-dentist-post-content">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/tele-dentist-sale-lander/theteledentist-logo.png"
                                    alt="theteledentist"
                                    data-src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/tele-dentist-sale-lander/theteledentist-logo.png"
                                    decoding="async" class="lazyload">
                                <!-- <h1 class="font-mont weight-500 m0 text-blue" style="color:#325077;">DISCOUNTS</h1> -->
                            </div>
                            <p class="open-sans tele-dentist-post-content" style="text-align:center">
                            Exclusive discounts for The Tele Dentists <br> patients & their families.
                            </p>
                            ...
                            <div class="whitening-teeth-girl-with-smile hidden-mobile">
                                ...
                                <div class="primary-head-image">
                                    <img src="https://www.smilebrilliant.com/wp-content/themes/revolution-child/assets/images/tele-dentist-sale-lander/tele-dentist-Image.png"
                                        alt=""
                                        data-src="https://www.smilebrilliant.com/wp-content/themes/revolution-child/assets/images/tele-dentist-sale-lander/tele-dentist-Image.png"
                                        decoding="async" class="lazyload">
                                </div>
                            ...
                            <div class="col-sm-4 geha-banner-text-section-parent">
                                <div class="geha-banner-text-section  mt-100">
                                    <p class="font-mont text-white prpt ">PRODUCT 
                                        PARTNER OF</p>
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/tele-dentist-sale-lander/theteledentist-logo.png"
                                        alt="One Dental" class="teledentists-logo-circle" />
                                    <div class="smtext">
                                        <div class="smtext-inr">
                                            <h2 class="font-mont fw-normal">
                                                <span class="weight-lower-mbt">Exclusive discounts for The Tele Dentists patients & their families.</span>
                                            </h2>
                                        ...
                                        <div class="widget widget_text">
                                            <div class="textwidget">
                                                <p>Smile Brilliant is America's #1 brand of customized oral care products
                                                    and a
                                                    proud partner of Tele Dentists Insurance. All Tele Dentists clients, their
                                                    children, domestic
                                            ...
                                            <div class="textwidget">
                                                ...
                                                <div class="seeDiscountBtn text-center">
                                                    <button class="btn btn-primary-blue btn-lg scroll-link"
                                                        href="#gehaform">SEE Tele Dentists DISCOUNTS</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="container-form">
                            <form id="geha_discount_registration_form" method="post">
                                <div class="row form-steps fullWidth">
                                    ...
                                    <input type="hidden" name="source" value="teledentists">
                                    ...
                                    <div class="col-md-12 text-center form-notes">
                                        <p class="text-white">By registering you will be able to bypass this page on future
                                            visits and view Tele Dentists exclusive discounts so long as we recognize your devise
    ...
    <?php if ($teledentistsFlag) {
        echo '<style>.footer {padding: 0px 0;}</style>
                    <div class="disclaimer-bar-purple bgColor">
                    <div class="container">
                     <p class="postLoggedin text-white">“<strong>DISCLAIMER:</strong> In order to recieve Tele Dentists exclusive pricing you must add to cart from this page.</i></p>
                    </div>
                    </div>';
    }
    ?>
    ...
    <div class="modal">
        <div class="modal-content">
            ...
            <div class="popupBodyContent text-center">
                ...
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/tele-dentist-sale-lander/theteledentist-logo.png"
                                        alt="teledentists" class="teledentists-logo-circle" />
                ...
                <p class="descriptionBody">Welcome Tele Dentists member! You now have access to give your exclusive
                Tele Dentists discounts. An email has also been sent to you with your account login details. To view
                ...
                <div class=" sep-top-sm text-center seeDiscountBtn text-center">
                    <a href="<?php echo site_url('teledentists?user=yes'); ?>" class="btn">SEE DISCOUNT PAGE</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    jQuery(document).on('click', '#skipPartner', function (e) {
        ...
        setCookiePartner('teledentistsOneTime', 'yes', 200, '/');
        location.reload();
    });
        ...
        jQuery.ajax({
            ...
            success: function (response) {
                ...
                if (response.status == true) {
                    ...
                    setCookiePartner('teledentistsOneTime', 'yes', 2000, '/');
                    // location.reload();
                    // setTimeout(function() {
    ...
    jQuery(document).on('change', 'input[name="fav_language"]', function() {
        ...
        var teledentists_sale_price = $(this).attr('data-teledentists_sale_price');
        if (typeof teledentists_sale_price !== 'undefined' && teledentists_sale_price !== false && teledentists_sale_price != '' && teledentists_sale_price > 0) {
            jQuery(this).parents('.product-selection-box').find('.add_to_cart_button').attr('data-teledentists_sale_price', teledentists_sale_price);
        } else {
            jQuery(this).parents('.product-selection-box').find('.add_to_cart_button').removeAttr('data-teledentists_sale_price');
        }
        jQuery(this).parents('.product-selection-box').find('.add_to_cart_button').attr('data-product_id', selected_product_id);
        jQuery(this).parents('.product-selection-box').find('.add_to_cart_button').attr('href', '?add-to-cart=' + selected_product_id);
        if (av_price != '') {
