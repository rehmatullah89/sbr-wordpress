<?php
/*Template Name: cordless water flosser v2*/
get_header();
?>
...
<section>
    <div class="section-head">
        <div>
            ...
            <p class="font-mont">This is your ONLY chance to <span style="color: #0d4666;font-size: 125%;font-weight: bold;">SAVE 50% <?php echo do_shortcode('[wfocu_product_save_percentage key="1"]'); ?></span> on the Cordless Water Flosser</p>
        </div>
    </div>
    ...
    <div class="product-wrapper">
                    ...
                    <div class="content-left-section">
                        <div class="show-only-desktop">
                            ...
                            Enjoy your<span style="color:#0eb4ba;"><br>EXCLUSIVE
                                    <?php echo do_shortcode('[wfocu_product_save_percentage key="1"]'); ?> 50% DISCOUNT</span>
                                <br>
                                <span style="color:#945aa5;">on the Cordless Water Flosser</span>
                            </h2>
                            <ul class="listing">
                                <li>Full 2-Year Warranty</li>
                                <li>Healthier Way to Floss</li>
                                <li>Removes 99.9% Plaque</li>
                                <li>Improves Gum Health</li>
                                <li>Hit Unreachable Areas</li>
                            </ul>
                        </div>
                        <div class="wraning-box">
                            <p class="">Only 8 CORDLESS WATER FLOSSERS left!</p>
                        ...
                        <div class="price-btn-box">
                            ...
                            <div class="content radio-90-days-content" id="radio-90-days-content">
                                ...
                                <div class="cart-button">
                                    <?php echo do_shortcode('[wfocu_yes_link  key="1"]Yes, I want clean teeth![/wfocu_yes_link]'); ?>
                                </div>
                            </div>
                ...
                <div class="col-5 m-order-1">
                    ...
                    <div class="product-image mrge-with-right-side">
                        ...
                        <div class="content show radio-60-days-content" id="">
                            ...
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/water-flosser.png" alt="" />

                            </div>
                            <!-- <div class="sbr-logo">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/sbr-logo.png" alt="" />

                            </div> -->
                            <div class="image-wrapper mbl-img">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/cordless-mbl.png" alt="" />
                    ...
                    <div class="thumbs-products">
                        <div class="d-flex align-items justify-content-center">
                            ...
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/thumb6.png" alt="" />

                               
                            </span>
                            <span class="item-thumbs">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/thumb-4.png" alt="" />

                               
                            </span>
                            <span class="item-thumbs brilliant-teeth">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/thumb-5.png" alt="" />
        ...
        <div class="no-thanks-wrap">
            <?php echo do_shortcode('[wfocu_no_link]No thanks, I don’t want  better flosser.[/wfocu_no_link]'); ?>
