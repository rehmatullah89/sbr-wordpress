<?php
/*Template Name: Electric Toothbrush upsell new*/
get_header();
?>
...
<section>
    <div class="section-head">
        <div>
            ...
            <p class="font-mont">This is your ONLY chance to <span style="color: #0d4666;font-size: 125%;font-weight: bold;">SAVE UP TO 60% <?php echo do_shortcode('[wfocu_product_save_percentage key="1"]'); ?></span> on the cariPRO Electric Toothbrush</p>
        </div>
    </div>
                ...
                <div class="col-7 m-order-2">
                    <div class="content-left-section">
                        <div class="show-only-desktop">
                            ...
                            <h2 class="font-mont">
                            This is your<span style="color:#0eb4ba;"><br>EXCLUSIVE
                                    <?php echo do_shortcode('[wfocu_product_save_percentage key="1"]'); ?> UP TO 60% OFF</span>
                                <br>
                                <span style="color:#945aa5;">the cariPRO TOOTHBRUSH</span>
                            </h2>
                            <ul class="listing">
                        ...
                        <div class="wraning-box">
                            <p class="">Only 6 Electric Toothbrush left!</p>
                ...
                <div class="col-5 m-order-1">
                    ...
                    <div class="product-image mrge-with-right-side">
                        ...
                        <div class="content show radio-60-days-content" id="">
                            ...
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/electic-brush.png" alt="" />
                            ...
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/mbl-img.png" alt="" />
