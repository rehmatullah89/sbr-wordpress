<?php
/*Template Name:  One Dental Template New */
global $GEHA_PAGE_ID;
//$GEHA_PAGE_ID =  get_the_ID();
$GEHA_PAGE_ID = ONE_DENTAL_TEMPLATE_PAGE_ID;
...
if (isset($_GET['utm_campaign']) && $_GET['utm_campaign'] == 'userExists') {
    setcookie('1dental', 'yes', time() + (3600 * 24 * 360), '/');
    $_SESSION['1dental'] = 'yes';
    set_transient('1dental', 'yes', 365 * DAY_IN_SECONDS);
    if (is_user_logged_in()) {
        update_user_meta(get_current_user_id(), '1dental', 'yes');
    }
    $oneDentalFlag = true;
    if (function_exists('w3tc_flush_url')) {
        w3tc_flush_url(get_permalink(get_the_ID()));
...
if (isset($_SESSION['1dental']) && $_SESSION['1dental'] == 'yes') {
    $oneDentalFlag = true;
}
if (isset($_COOKIE['1dentalOneTime']) && $_COOKIE['1dentalOneTime'] == 'yes') {
    $oneDentalFlag = true;
    setcookie('1dentalOneTime', '', time() - 100000, '/');
}
if (get_transient('1dental') == 'yes') {
    // $oneDentalFlag = true;
}

if (is_user_logged_in()) {
    if (get_user_meta(get_current_user_id(), '1dental', true) == 'yes') {
        $oneDentalFlag = true;
    }
}
...
<style>
    ...
    #gehaPage .gehanFormSection .gehaLoginCustomer h3 a{
        /* color: #0c2242; */
        font-weight: 400;
    }
    #gehaPage .splitTwo {
...
<div class="gehaTemplate active-recomendation-tab" id="gehaPage">
    ...
    if ($oneDentalFlag) {
        $page_id = ONE_DENTAL_REC_PAGE_ID; // Replace 123 with the ID of the page you want to retrieve
    ...
    ?>
                ...
                <div class="pageHeader">
                    ...
                    <div class="pageheaderTop">
                        ...
                        <div class="row no-flex">
                            <h1 class="font-mont weight-500  text-white"><span style="color: #376a9b;">1D</span>ental MEMBER <span style="color: #376a9b;">DISCOUNTS</span></h1>
                            <p class="open-sans text-white">
                                Welcome <span style="color: #376a9b;">1Dental</span> member! Your 1Dental Discount Plan entitles you <br> to exclusive pricing on the below listed Smile Brilliant oral care products.
                            </p>
                            ...
                            <div class="col-sm-4 geha-banner-text-section-parent">
                                <div class="geha-banner-text-section  mt-100">
                                    ...
                                    <h1 class="gehaLogoLarge">
                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/one-dental/one-dental-logo.png" alt="One Dental" class="" />
                                    </h1>
                                    <h2 class="font-mont text-white">Exclusive discounts for<br>
                                        1Dental Discount Plan <br> members & their families!</h2>
                                        ...
                                        <div class="widget widget_text">
                                            <div class="textwidget">
                                                <p>Smile Brilliant is America's #1 brand of customized oral care products and a
                                                    proud partner of 1dental Insurance. All 1dental clients, their children, domestic
                                    ...
                                    <div class="vc_wp_text wpb_content_element order-the-system-cnt">
                                        <div class="widget widget_text">
                                            <div class="textwidget">
                                                ...
                                                <div class="seeDiscountBtn text-center">
                                                    <button class="btn btn-primary-blue btn-lg scroll-link" href="#gehaform">SEE YOUR 1DENTAL DISCOUNTS</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="container-form">
                            <form id="geha_discount_registration_form" method="post">
                                <div class="row form-steps fullWidth">
                                    ...
                                    <input type="hidden" name="source" value="1dental">
                                    <input type="hidden" name="action" value="add_partner_user">
                                    <div class="col-md-12 text-center form-notes">
                                        <p class="text-white">By registering you will be able to bypass this page on future visits and view 1DENTAL discounts so long as we recognize your devise or you’re logged in to your Smile Brilliant account.<strong>DISCLAIMER:</strong><i> By signing up for these discounts you agree to be added to our email subscriber list for promotional and order related information. You can always update and manage your preferences by clicking at the footer of all emails.</i></p>
                                    </div>
            ...
            <?php if ($oneDentalFlag) {               
                    echo '<style>.footer {padding: 0px 0;}</style>
                    <div class="disclaimer-bar-purple bgColor">
                    <div class="container">
                     <p class="postLoggedin text-white">“<strong>DISCLAIMER:</strong><i> In order to recieve 1DENTAL exclusive pricing you must add to cart from this page.</i></p>
                    </div>
                    </div>';
            }
            ?>
    ...
    <div class="modal">
        <div class="modal-content">
            ...
            <div class="popupBodyContent text-center">
                ...
                <p class="descriptionBody">Welcome 1DENTAL member! You now have access to give your exclusive 1DENTAL discounts. An email has also been sent to you with your account login details. To view your discounts in the future, simply login. Our live chat and customer support team is also here to help!<br><br>
                ...
                <div class=" sep-top-sm text-center seeDiscountBtn text-center">
                    <a href="<?php echo site_url('1dental?user=yes'); ?>" class="btn">SEE DISCOUNT PAGE</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    jQuery(document).on('click', '#skipPartner', function(e) {
        ...
        setCookiePartner('1dentalOneTime', 'yes', 200, '/');
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                if (response.status == true) {
                    ...
                    setCookiePartner('1dentalOneTime', 'yes', 2000, '/');
                    toggleModal();    
                  //  location.reload();
                } else {
                    Swal.fire({
    ...
    jQuery(document).on('change', 'input[name="fav_language"]', function() {
        ...
        var dental_sale_price = $(this).attr('data-1dental_sale_price');
        if (typeof dental_sale_price !== 'undefined' && dental_sale_price !== false && dental_sale_price != '' && dental_sale_price > 0) {
            jQuery(this).parents('.product-selection-box').find('.add_to_cart_button').attr('data-1dental_sale_price', dental_sale_price);
        } else {
            jQuery(this).parents('.product-selection-box').find('.add_to_cart_button').removeAttr('data-1dental_sale_price');
        }
        jQuery(this).parents('.product-selection-box').find('.add_to_cart_button').attr('data-product_id', selected_product_id);
        jQuery(this).parents('.product-selection-box').find('.add_to_cart_button').attr('href', '?add-to-cart=' + selected_product_id);
        if (av_price != '') {
