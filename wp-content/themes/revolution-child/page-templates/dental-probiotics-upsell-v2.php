<?php
/*Template Name: Dental probiotic upsell v2*/
get_header();
?>
...
<section>
    <div class="section-head">
        <div>
            ...
            <p class="font-mont">This is your ONLY chance to <span style="color: #0d4666;font-size: 125%;font-weight: bold;">Save 50%  <?php echo do_shortcode('[wfocu_product_save_percentage key="1"]'); ?></span> on Dental Probiotics</p>
        </div>
    </div>
    ...
    <div class="product-wrapper">
                ...
                <div class="col-5 m-order-1">
                    ...
                    <div class="product-image mrge-with-right-side">
                        ...
                        <div class="content show radio-60-days-content" id="">
                            ...
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/dental.png" alt="" />
                            ...
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/probiotic-mbl.png" alt="" />
                    ...
                    <div class="thumbs-products">
                        <div class="d-flex align-items justify-content-center">
                            ...
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/dental1.png" alt="" />

                               
                            </span>
                            <span class="item-thumbs">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/dental2.png" alt="" />

                               
                            </span>
                            <span class="item-thumbs brilliant-teeth">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/upsell/dental3.png" alt="" />
        ...
        <div class="no-thanks-wrap">
            <?php echo do_shortcode('[wfocu_no_link]No thanks, I don’t want better oral care.[/wfocu_no_link]'); ?>
