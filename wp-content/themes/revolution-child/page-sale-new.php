<?php
/*
Template Name: Permanent Sale Page
*/
get_header();
?>
...
<style type='text/css'>
    ...
    @media (min-width: 767px) {
        ...
        .row-t.product-item-display .col-lg-12 .product-selection-box:nth-child(3) .product-selection-title-text-wrap {
            max-width: 860px;
            margin-top: -45px;
        }
...
<section class="page-wrapper">
    ...
    //get_template_part('inc/templates/sale/sale-page/prime-day-sale-2022');
    ?>
            ...
            <div class="row-t product-item-display">
                <div class="col-lg-12 itemProducts">
                    ...
                    while ($loop->have_posts()) : $loop->the_post();
                        ...
                        $sale_price =  get_post_meta($pid, '_price', true) - get_post_meta($pid, 'sale_page_discount', true);
                                ...
                                <div class="col-sm-6 col-md-5 product-selection-description-text-wrap">
                                    <div class="product-selection-description-text">
                                        ...
                                        <div class="row-mbt-product justify-content-between maxwidth80" style="margin-top:60px;">
                                            ...
                                            ?>
                                            <?php if($sale_price<get_post_meta($pid, '_price', true)){ ?><div class="original-price">
                                                    <div class="price-heading gray-text">ORIGINAL PRICE</div>
                                                    <div class="price-was gray-text line-thorough"><span class="doller-sign">$</span><?php echo get_post_meta($pid, '_price', true); ?></div>
                                                </div> <?php } else {
                                                    ?>
 <div class="sale-price" style="display:contents">
                                                    <div class="price-heading blue-text">ORIGINAL PRICE</div>
                                                    <div class="price-new "><span class="doller-sign">$</span><?php echo get_post_meta($pid, '_price', true); ?></div>
                                                </div>
                                                    <?php
                                            }?>
                                                
                                                <?php if($sale_price<get_post_meta($pid, '_price', true)){?>
                                                <div class="sale-price">
                                                    <div class="price-heading blue-text">SALE PRICE</div>
                                        ...
                                        <div class="add-to-cart">
                                            ...
                                            ?>
                                                <button class="btn btn-primary-blue btn-lg product_type_simple add_to_cart_button ajax_add_to_cart <?php echo $addedClass; ?>" <?php echo  $string_bogo; ?> href="?add-to-cart=<?php echo $pid; ?>" data-quantity="1" data-product_id="<?php echo $pid; ?>" data-discount="<?php echo get_post_meta($pid, 'sale_page_discount', true); ?>" data-action="woocommerce_add_order_item">ADD TO CART</button>
                                            <?php
                                            } ?>
