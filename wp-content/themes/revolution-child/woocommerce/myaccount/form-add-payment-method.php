...
<div class="d-flex align-items-center menuParentRowHeading paymentMethodFile">
            <div class="pageHeading_sec">
                <span><span class="text-blue">Payment Methods</span>Manage payment Methods.</span> 
            </div>                        
            </div>
			...
			<ul class="woocommerce-PaymentMethods payment_methods methods ">
				...
				foreach ( $available_gateways as $gateway ) {
					...
					<li class="woocommerce-PaymentMethod woocommerce-PaymentMethod--<?php echo esc_attr( $gateway->id ); ?> payment_method_<?php echo esc_attr( $gateway->id ); ?>">
						<input id="payment_method_<?php echo esc_attr( $gateway->id ); ?>" type="radio" class="input-radio visibilityHidden" name="payment_method" value="<?php echo esc_attr( $gateway->id ); ?>" <?php checked( $gateway->chosen, true ); ?> />
