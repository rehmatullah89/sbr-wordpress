...
// If checkout registration is disabled and not logged in, the user cannot checkout.
        ...
        <form name="checkout" method="post" class="checkout woocommerce-checkout"
            ...
            if (woo_in_cart_mbt(130262)) {
                $stylepop = "none";
            }
            ?>
            <div class="popup-container modal fade in" id="gehaBrushHeadPromoModal" style="display:<?php echo $stylepop; ?>">
                ...
                <div class="modal-dialog">                    
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            ...
                            <h1 style="font-size:25px;line-height:1.3em;font-weight:bold;margin-top:0;">ADD <span style="color:#3c98cc;">EXTRA</span> BRUSH HEADS<br>TO YOUR ORDER &amp; SAVE</h1>
                            <div style="padding-left:22%;padding-right:22%;">
                                <img style="width:100%;" src="<?php echo get_the_post_thumbnail_url(130262, 'full'); ?>">
                            </div>
                            <h1 style="font-size:3.2em;line-height:1.3em;font-weight:bold;margin-top:10px;margin-bottom:0px;padding-bottom:0px;">ONLY $<?php echo $price = get_post_meta(130262, '_regular_price', true); ?>
                            </h1>
                            <p style="font-size:0.9em;margin-top:7px;;margin-bottom:7px;">Includes 2 brush heads</p>
                            ...
                            <button style="background-color:#4696cc;color:#fff;width:90%;border:1px solid #fff;" class="btn btn-primary-blue product_type_composite add_to_cart_button ajax_add_to_cart" href="?add-to-cart=130262" data-quantity="1" data-product_id="130262" data-action="woocommerce_add_order_item">ADD TO CART</button>
                            <div style="height:10px;"></div>
                            <button type="button" class="btn btn-primary no-thanks-close" data-dismiss="modal" style="background-color:#dcdcdc;color:#555759;width:90%;border:1px solid #fff;">NO, THANKS</button>
